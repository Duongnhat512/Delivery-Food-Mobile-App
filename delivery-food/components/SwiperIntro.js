    ...
    return (
        ...
        >
            <View style={styles.slide}>
                ...
                <Text style={{fontFamily: "Inter"}}>Tinh hoa ẩm thực, tận hưởng tại nhà.</Text>
            </View>
            <View style={styles.slide}>
                <Image
                ...
                <Text style={{fontFamily: "Inter"}}>Thanh toán nhanh chóng, đơn giản chỉ với vài thao tác.</Text>
            </View>
            <View style={styles.slide}>
                <Image
                ...
                <Text style={{fontFamily: "Inter"}}>Uy tín, chất lượng, giao hàng đúng hẹn.</Text>
            </View>
        </Swiper>
    )
})
